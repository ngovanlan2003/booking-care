...
class BookingModal extends Component {
    ...
    async componentDidUpdate(prevProps, prevState) {
        if(this.props.language !== prevProps.language) {
            this.setState({
                genders: this.buildDataGenger(this.props.genders)
            })
        }
    ...
    render() {
        let {isOpenModalBookingParent, closeBookingModal, dataTime} = this.props
        let doctorId = ''
        if(dataTime) {
        ...
        return (
            <Modal 
                isOpen={isOpenModalBookingParent} 
            ...
            >
                <div className='booking-modal-content'>
                    <div className='booking-modal-header'>
                        <span className='left'><FormattedMessage id="patient.booking-modal.inform" /></span>
                        <span
